...
import com.nsavage.stepcast.ui.screens.CategoryScreen
import com.nsavage.stepcast.ui.screens.FullPlayerSheet
import com.nsavage.stepcast.ui.screens.HistoryScreen
import com.nsavage.stepcast.ui.screens.HomeScreen
import com.nsavage.stepcast.ui.screens.PlayerBar
import com.nsavage.stepcast.ui.screens.PodcastScreen
import com.nsavage.stepcast.ui.screens.QueueScreen
import com.nsavage.stepcast.ui.screens.SearchScreen
import com.nsavage.stepcast.ui.screens.SettingsScreen
import com.nsavage.stepcast.ui.screens.SmartPlayEditorScreen
import com.nsavage.stepcast.ui.theme.StepcastTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleSmartPlayShortcut(intent: android.content.Intent?) {
        if (intent?.action != com.nsavage.stepcast.SmartPlayShortcuts.ACTION_START) return
        val name = intent.getStringExtra("smartplay") ?: return
        sendBroadcast(
            android.content.Intent(
                this, com.nsavage.stepcast.playback.CommandReceiver::class.java
            )
                .setAction(
                    com.nsavage.stepcast.playback.CommandReceiver.ACTION_START_SMART_PLAY
                )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val darkTheme = when (com.nsavage.stepcast.ui.theme.ThemePrefs.mode) {
                com.nsavage.stepcast.ui.theme.ThemeMode.DARK -> true
                com.nsavage.stepcast.ui.theme.ThemeMode.LIGHT -> false
...
fun StepcastApp(player: PlayerConnection, sharedFeedUrl: String? = null) {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("inbox") {
                com.nsavage.stepcast.ui.screens.InboxScreen(
                    repository = app.repository,
                    player = player,
            ...
            composable("librarysearch") {
                com.nsavage.stepcast.ui.screens.LibrarySearchScreen(
                    repository = app.repository,
                    player = player,
                    playerState = playerState,
                    onPodcastClick = { navController.navigate("podcast/$it") }
            ...
            composable("downloads") {
                com.nsavage.stepcast.ui.screens.DownloadsScreen(
                    repository = app.repository
                )
            }
            composable("history") {
            ...
            composable(
                ...
                com.nsavage.stepcast.ui.screens.PodcastPreviewScreen(
                    feedUrl = feedUrl,
                    repository = app.repository,
                    player = player,
                    onSubscribed = {
