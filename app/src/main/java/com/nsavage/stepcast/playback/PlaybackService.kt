...
import com.nsavage.stepcast.data.ListenStats
import com.nsavage.stepcast.ui.MainActivity
import com.nsavage.stepcast.data.Chapter
import com.nsavage.stepcast.data.Episode
import com.nsavage.stepcast.data.Podcast
import com.nsavage.stepcast.widget.StepcastWidget
...
class PlaybackService : MediaLibraryService() {
    ...
    private fun onSleepShake() {
        ...
        android.widget.Toast.makeText(
            this,
            getString(com.nsavage.stepcast.R.string.sleep_timer_plus_10),
    ...
    private fun startSmartPlayByName(name: String) {
        serviceScope.launch {
            var started: com.nsavage.stepcast.data.SmartPlay? = null
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER = "com.nsavage.stepcast.SLEEP_TIMER"
        const val ACTION_DONE_DELETE = "com.nsavage.stepcast.DONE_DELETE"
        const val ACTION_SEEK_BACK = "com.nsavage.stepcast.SEEK_BACK"
        const val ACTION_SEEK_FORWARD = "com.nsavage.stepcast.SEEK_FORWARD"
        const val ACTION_AD_JUMP = "com.nsavage.stepcast.AD_JUMP"
        const val ACTION_START_SMARTPLAY = "com.nsavage.stepcast.START_SMARTPLAY"
        const val ACTION_REFRESH_NOTIF_BUTTONS =
            "com.nsavage.stepcast.REFRESH_NOTIF_BUTTONS"
